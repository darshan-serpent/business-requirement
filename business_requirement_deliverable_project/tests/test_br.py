...
#
    ...
    def test_project_generate_project_wizard(self):
        ...
        self.brB.state = 'approved'
        self.brC.state = 'approved'
        default_uom = self.env.user.company_id.project_time_mode_id.id
